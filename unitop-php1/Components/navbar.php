...
<head>
    ...
    <style>
        ...
        /* ============================================== */
        /* === NÂNG CẤP: MEDIA QUERIES FOR RESPONSIVE === */
        /* ============================================== */
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="#">Sửa chữa hộp số</a></li>
                                    <li><a href="#">Sửa chữa hệ thống điện</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="#">Rửa xe <i class="fas fa-chevron-down"></i></a>
                                <ul class="sub-menu">
                                    <li><a href="#">Rửa xe cơ bản</a></li>
                                    <li><a href="#">Rửa xe chi tiết</a></li>
                                    <li><a href="#">Vệ sinh nội thất</a></li>
                                    <li><a href="#">Tẩy ố & Đánh bóng</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
