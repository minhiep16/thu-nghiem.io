...
--
-- Cấu trúc bảng cho sản phẩm/dịch vụ khung gầm
-- Bảng này bạn đã có và đang sử dụng
--
...
--
-- Thêm một vài dữ liệu mẫu cho bảng `chassis`
--
...
-- Bảng này rất quan trọng cho chức năng "Check Out"
--
CREATE TABLE `orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Bảng này liên kết sản phẩm với đơn hàng
--
...
--
-- Ràng buộc khóa ngoại cho bảng `order_details`
--
