document.addEventListener('DOMContentLoaded', function() {
    ...
    const textsToType = [
        { element: h1TextElement, text: "PPF", speed: 100, delayAfter: 500, clearBeforeTyping: true },
        { element: pTextElement, text: "DÁN PPF", speed: 80, delayAfter: 500, clearBeforeTyping: true }
    ];
